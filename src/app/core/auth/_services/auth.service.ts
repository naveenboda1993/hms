...
const API_USERS_URL = 'https://backendapp-hms.herokuapp.com/api/chat/login';
...
export class AuthService {
  ...
  login(email: string, password: string): Observable<User> {
    return this.http.post<User>('https://backendapp-hms.herokuapp.com/api/login', {email, password});
  }
  ...
  register(user: User): Observable<any> {
    ...
    return this.http.post<User>(' https://backendapp-hms.herokuapp.com/api/register', user, {headers: httpHeaders})
      .pipe(
        map((res: User) => {
          return res;
        }),
